...
impl RequestBuilder{
    pub fn new(
        ...
        RequestBuilder{
            ...
            last_channel:Arc::new(StdMutex::new(1)),
    ...
    pub async fn send(&self,body:gObject,timeout_in_millis:u64,encrypted:bool) -> Result<Response,Error>{
        ...
        if !channel_found{
            return Err(Error!("failed-get_channel_id"));
        }
        ...
        if encrypted{
            ...
            match passwords.get(&channel_id){
                Some(password)=>{
